// miniprogram/pages/Spring_Winter/SW.js
Page({
...
var data = this.data.user_data - 0b10000000;
  ...
  EnterPoster: function(){
    wx.navigateTo({
      url: '../Spring_Poster/Poster?user_data1='+this.data.user_data1+"&user_data2="+this.data.user_data2+"&user_data3="+this.data.user_data3+"&user_data4="+this.data.user_data, //结束
    })
